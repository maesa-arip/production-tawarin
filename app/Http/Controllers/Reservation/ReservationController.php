        ...
        if ($reservationCompany->reservationcategory->name == 'Cuci Mobil') {
            ...
            if ($reservationCustomer1->jumlahlayanandiskon === 0) {
                ...
                try {
                    ...
                    return redirect('myreservations')->with([
                        'type' => 'error',
                        'message' => 'Konfirmasi pelayanan gagal, silakan coba kembali1',
                    ]);
                }
            }
            ...
            if ($reservationCustomer2 + 1 === $reservationCustomer1->jumlahlayanandiskon && !$checkPegawai) {
                ...
                try {
                    ...
                    return redirect('myreservations')->with([
                        'type' => 'error',
                        'message' => 'Konfirmasi pelayanan gagal, silakan coba kembali2',
                    ]);
                }
            }
            ...
            if ($reservationCustomer2 + 1 === $reservationCustomer1->jumlahlayanandiskon && $checkPegawai) {
                ...
                try {
                    ...
                    return redirect('myreservations')->with([
                        'type' => 'error',
                        'message' => 'Konfirmasi pelayanan gagal, silakan coba kembali3',
                    ]);
                }
            }
            ...
            if ($reservationCustomer2 + 1 < $reservationCustomer1->jumlahlayanandiskon) {
                ...
                try {
                    ...
                    return redirect('myreservations')->with([
                        'type' => 'error',
                        'message' => 'Konfirmasi pelayanan gagal, silakan coba kembali4',
                    ]);
                }
            }
        }
        ...
        if ($reservationCompany->reservationcategory->name == 'Barber Shop') {
            ...
            if ($reservationCustomer1->jumlahlayanandiskon === 0) {
                ...
                try {
                    ...
                    return redirect('myreservations')->with([
                        'type' => 'error',
                        'message' => 'Konfirmasi pelayanan gagal, silakan coba kembali5',
                    ]);
                }
            }
            // Pas dengan layanan gratis dan bukan pegawai
            if ($reservationCustomer2 + 1 === $reservationCustomer1->jumlahlayanandiskon && !$checkPegawai) {
                ...
                try {
                    ...
                    return redirect('myreservations')->with([
                        'type' => 'error',
                        'message' => 'Konfirmasi pelayanan gagal, silakan coba kembali6',
                    ]);
                }
            }
            // Pas dengan layanan gratis dan pegawai
            if ($reservationCustomer2 + 1 === $reservationCustomer1->jumlahlayanandiskon && $checkPegawai) {
                ...
                try {
                    ...
                    return redirect('myreservations')->with([
                        'type' => 'error',
                        'message' => 'Konfirmasi pelayanan gagal, silakan coba kembali7',
                    ]);
                }
            }
            //Masih kurang dari layanan gratis
            if ($reservationCustomer2 + 1 < $reservationCustomer1->jumlahlayanandiskon) {
                ...
                try {
                    ...
                    return redirect('myreservations')->with([
                        'type' => 'error',
                        'message' => 'Konfirmasi pelayanan gagal, silakan coba kembali8',
                    ]);
                }
            }
        }
