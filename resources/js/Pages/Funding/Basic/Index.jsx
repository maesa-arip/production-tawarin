...
export default function Index(props) {
    const { data: fundings, meta, filtered, attributes } = props.fundings;
    ...
    const openDestroyDialog = (funding) => {
        setState(funding);
        setIsOpenDestroyDialog(true);
    };

    const destroyUser = () => {
        Inertia.delete(route("fundings.destroy", state.id), {
    ...
    return (
        <>
            ...
            <div className="lg:hidden ">
                ...
                <div className="w-1/2">
                            <div className="flex items-center justify-start mt-2 mb-0 gap-x-2">
                                <NavLink
                                    type="button"
                                    className={
                                        "justify-start px-4 py-2 text-sm font-medium text-blue-900 bg-blue-100 border border-transparent rounded-md hover:bg-blue-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
