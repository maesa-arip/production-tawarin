...
export default function Index(props) {
    const { data: portofolios, meta, filtered, attributes } = props.portofolios;
    ...
    const openDestroyDialog = (portofolio) => {
        setState(portofolio);
        setIsOpenDestroyDialog(true);
    };

    const destroyPortofolio = () => {
        Inertia.delete(route("portofolios.destroy", state.id), {
    ...
    return (
        <>
            ...
            <Header title="Portofolio" description="List Portofolio Saya." />
            <Container>
                <DestroyModal
                ...
                >
                    <Button color={"pink"} onClick={destroyPortofolio}>
                        Hapus
                    </Button>
                </DestroyModal>
                    ...
                    <div className="flex items-center justify-end">
                        <div className="w-1/2">
                            <div className="flex items-center justify-start mb-6 gap-x-2">
                                <ThirdButton type="button" href={"portofolios/create"}>Tambah Portofolio</ThirdButton>
                            </div>
                        </div>
                        <div className="w-1/2">
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <div className="flex mt-1 rounded-md shadow-sm">
                                                            ...
                                                            <div className="flex-1 block w-full px-2 py-1 text-base border border-l-0 border-gray-300 rounded-none rounded-r-md focus:border-indigo-500 focus:ring-indigo-500">
                                                                {numberFormat(
                                                                    portofolio.anggaran_proyek
                                                                )}
                                                            </div>
                                                        </div>
                                                    </td>
                                                    {portofolio.portofolio_bids_sum_is_approved ==
                                                    "1" ? (
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            <Button>
                                                                Sudah Memilih
                                    ...
                                    <div className="flex flex-col items-center justify-center flex-auto p-2">
                                        <div className="grid w-full grid-cols-12 gap-1">
                                            ...
                                            <div className="col-span-10 col-start-3 mb-2">
                                                ...
                                                <p className="text-xs font-medium text-gray-500">
                                                    {portofolio.portofolio_bids_count}{" "}
                                                    Penawar
                                                </p>
                                            </div>
