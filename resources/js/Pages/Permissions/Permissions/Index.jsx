...
import CreatePermission from "@/Components/Permissions/Permissions/CreatePermission";
import EditPermission from "@/Components/Permissions/Permissions/EditPermission";
...
export default function Index(props) {
    const { data: permission, meta, filtered, attributes } = props.permissions;
    ...
    const openEditDialog = (permissions) => {
        setState(permissions);
        setIsOpenEditDialog(true);
    };
    const openDestroyDialog = (permissions) => {
        setState(permissions);
        setIsOpenDestroyDialog(true);
    };

    const destroypermission = () => {
        Inertia.delete(route("permissions.destroy", state.id), {
    ...
    return (
        <>
            ...
            >
                <Button color={"pink"} onClick={destroypermission}>
                    Delete
                </Button>
            </DestroyModal>
