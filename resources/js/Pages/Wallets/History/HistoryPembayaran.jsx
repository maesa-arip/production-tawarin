...
export default function HistoryUtama(props) {
    const {
        data: transaction,
        meta,
        filtered,
                ...
                <div className="py-12">
                    <div className="mx-auto">
                        ...
                        <div className="flex gap-x-2 my-2 overflow-x-scroll">
                            ...
                            <ThirdButtonSmall color="tawarin_outline">TopUp</ThirdButtonSmall>
                            <ThirdButtonSmall color="tawarin_outline">Withdraw</ThirdButtonSmall>
                            <ThirdButtonSmall color="tawarin_outline">Bagi_Hasil</ThirdButtonSmall>
                            <ThirdButtonSmall color="tawarin_outline">Pembayaran</ThirdButtonSmall>
                        </div>
...
HistoryUtama.layout = (page) => <App children={page} />;
