...
export default function Index(props) {
    ...
    const reload = useCallback(
        debounce((query) => {
            Inertia.get(route("plans.index"), {...pickBy(query), page: query.page}, {
                preserveState: true,
                preserveScroll: true,
            });
        }, 150),
                                        ...
                                        <thead className="bg-gray-50">
                                            <tr>
                                                ...
                                                <th
                                                    ...
                                                    className="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-800 uppercase"
                                                >
                                                    <div className="flex items-center cursor-pointer gap-x-2" onClick={()=>sort('slug')}>
                                                        Slug
                                                        { params.field == "slug" && params.direction == "asc" && <UpIcon/> }
                                                        { params.field == "slug" && params.direction == "desc" && <DownIcon/> }
                                                    </div>
                                                </th>
                                                <th
                                                    scope="col"
                                                ...
                                                <th
                                                    ...
                                                    className="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-800 uppercase"
                                                >
                                                    <div className="flex items-center cursor-pointer gap-x-2" onClick={()=>sort('jumlah_revisi')}>
                                                        Jumlah Revisi
                                                        { params.field == "jumlah_revisi" && params.direction == "asc" && <UpIcon/> }
                                                        { params.field == "jumlah_revisi" && params.direction == "desc" && <DownIcon/> }
                                                    </div>
                                                </th>
                                                <th
                                                    scope="col"
                                                    className="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-800 uppercase"
                                                >
                                                    <div className="flex items-center cursor-pointer gap-x-2" onClick={()=>sort('anggaran_proyek')}>
                                                        Anggaran Proyek
                                                        { params.field == "anggaran_proyek" && params.direction == "asc" && <UpIcon/> }
                                                        { params.field == "anggaran_proyek" && params.direction == "desc" && <DownIcon/> }
                                                    </div>
                                                </th>
                                                <th
                                                    scope="col"
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            {plans.map((plan, index) => (
                                                <tr key={plan.id}>
                                                    ...
                                                    <td>
                                                        <button className="flex items-center gap-x-2" onClick={()=>openEditDialog(plan)}>Edit</button>
                                                        <button className="flex items-center gap-x-2" onClick={()=>openDestroyDialog(plan)}>Delete</button>
            ...
            <div className="flex items-center justify-end">
                        <div className="w-full">
                            ...
                            <div className="flex items-center px-2 transition duration-150 ease-in-out bg-white border border-gray-300 rounded-lg gap-x-2 focus-within:border-blue-400 focus-within:ring-blue-200 focus-within:ring">
                                    ...
                                    <input type="text" autoComplete="off" name="q" id="q" onChange={onChange} value={params.q} className="w-full border-0 focus:ring-0 form-text" />
                            </div>
                                ...
                                <div className="grid grid-cols-2 grid-rows-1 gap-4 mt-2">
                                    <p className="inline-flex flex-col text-gray-800 xl:flex-row xl:items-center">
                                        ...
                                        <span className="text-sm">
                                            {numberFormat(plan.dari_anggaran)}
                                        </span>
                                    </p>
                                    <p className="inline-flex flex-col text-gray-800 xl:flex-row xl:items-center">
                                        {/* <svg
                                        ...
                                        <span className="text-sm">
                                            {numberFormat(plan.sampai_anggaran)}
                                        </span>
                                    </p>
                                </div>
