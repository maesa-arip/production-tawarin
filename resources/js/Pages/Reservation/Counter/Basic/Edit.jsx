...
export default function Edit({
    ...
    const { data, setData, patch, processing, reset, errors } = useForm({
        ...
        reservation_car_category_id:
            reservationCounter.reservation_car_category_id,
    });
    ...
    const [selectedTeamOrPerson, setSelectedTeamOrPerson] = useState();
    ...
    useEffect(() => {
        setData({
            ...data,
            ["percent_employe"]: 100 - parseInt(data.percent_owner),
        });
    ...
    useEffect(() => {
        setData({
            ...data,
            ["price_user"]: parseInt(data.bhp) + parseInt(data.jasa),
        });
    ...
    return (
        <div>
            ...
            >
                <p>
                    Apakah anda akan memberikan komisi kepada pegawai untuk
                    layanan ini ?
                </p>
                <ThirdButtonNoLink
                    type="button"
            ...
            >
                <p>
                    Apakah anda akan memberikan diskon kepada pelanggan untuk
                    layanan ini ?
                </p>
                                    ...
                                    <div className="px-4 py-5 bg-white sm:p-6">
                                        <div className="grid grid-cols-12 gap-6">
                                            {reservationCounter.reservation_car_category_id ? (
                                                <div className="col-span-12 md:col-span-6">
                                                    ...
                                                    <ListBoxPage
                                                        ...
                                                        onChange={(e) => {
                                                            onChangeReservationCarCategoryId(
                                                                e
                                                            );
                                                            setSelectedCategory(
                                                                e
                                            ...
                                            <div className="col-span-12 px-3 py-4 mb-6 text-sm text-gray-500 rounded shadow md:col-span-8">
                                                ...
                                                Bonus diambil dari persentase
                                                untuk owner, bonus diberikan
                                                jika pelanggan memberikan rating
                                                full 5 bintang untuk semua
                                                kategori .
                                            </div>
                                            <div className="col-span-12 px-3 py-4 mb-6 text-sm text-gray-500 rounded shadow md:col-span-8">
                                                <svg
                                            ...
                                            <div className="col-span-12 md:col-span-6">
                                                <label
                                                    ...
                                                    className="block text-sm font-medium text-gray-700"
                                                >
                                                    Jumlah Layanan untuk
                                                    Mendapat Layanan Gratis
                                                </label>
                                                <div className="flex mt-1 rounded-md">
                                                    <div className="flex items-center w-full px-2 bg-white border border-gray-300 rounded-md shadow-sm gap-x-0 sm:text-sm focus-within:border-indigo-500 focus-within:ring-indigo-500 focus-within:ring-1">
                                                        <input
