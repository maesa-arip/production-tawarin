                                        ...
                                        <div>
                                            ...
                                            <div className="flex justify-center px-6 pt-5 pb-6 mt-1 border-2 border-gray-300 border-dashed rounded-md">
                                                <div className="w-full text-center">
                                                    <div className="mb-6 mx-2 md:mx-4 lg:mx-6 bg-white rounded-lg shadow">
                                                    ...
                                                    <div className="mb-6 mx-2 md:mx-4 lg:mx-6 bg-white rounded-lg shadow">
                                                        <div className="px-2 py-6 mx-3 mt-6 text-sm font-medium text-gray-400 mb-7">
                                                            <div className="grid grid-cols-2 md:grid-cols-6 col-span-2 gap-2 ">
                                                                {media.map(
                                                                    (
                                                                        plan,
                                                                        index
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            className="w-auto h-auto col-span-2 overflow-hidden shadow rounded-xl relative "
                                                                        >
                                                                            {plan.mime_type ==
                                                                            "video/mp4" ? (
                                                                                <>
                                                                             ...
                                                                             <button
                                                                                        ...
                                                                                        type="button"
                                                                                        className="absolute flex items-center justify-between cursor-pointer top-0 right-0 group focus:outline-none"
                                                                                        data-carousel-prev
                                                                                    >
                                                                                        <span className="inline-flex items-center justify-center w-5 h-5 bg-pink-300 rounded sm:w-10 sm:h-10 dark:bg-gray-800/30 group-hover:bg-pink-400 dark:group-hover:bg-gray-800/60 ring-4 ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none ">
                                                                                            <IconTrash className="w-3 h-3 md:w-5 md:h-5 text-white sm:w-6 sm:h-6 dark:text-gray-800"/>
                                                                                        </span>
                                                                                    </button>
                                                                        </div>
                                                                    )
