    ...
    return (
        <>
            ...
            >
                    ...
                    <blockquote className="relative">
                        ...
                        <div className="relative z-10">
                            <p className="text-justify text-gray-800 sm:text-xl dark:text-white">
                                <em>
                                    {model2.reservationCompany.pernyataan ? model2.reservationCompany.pernyataan : <>Dengan klik Simpan, saya menyatakan setuju
                                    dengan kebijakan yang berlaku dan
                                    mengonfirmasi bahwa tidak ada barang
                                    berharga atau barang pribadi yang tertinggal
                                    di dalam kendaraan. Segala risiko yang
                                    timbul akibat kelalaian pengecekan menjadi
                ...
                {isAgree === true ? <ThirdButtonNoLink
                    processing={processing}
                    onClick={pilihLayanan}
                >
                    Simpan
                </ThirdButtonNoLink>: <ThirdButtonNoLink
                    color="gray" className="pointer-events-none"
                >
                    Klik Setuju Dahulu
                </ThirdButtonNoLink>}
