...
export default function Index(props) {
    const { data: reservationRatingCategories, meta, filtered, attributes } = props.reservationRatingCategories;
    ...
    const destroyquestion = () => {
        Inertia.delete(route("reservationRatingCategories.destroy", state.id), {
    ...
    return (
        <>
            ...
            >
                <Edit
                    reservationRatingCategories={reservationRatingCategories}
                    model={state}
                    isOpenEditDialog={isOpenEditDialog}
                    setIsOpenEditDialog={setIsOpenEditDialog}
                />
                                ...
                                <div className="border-b border-gray-200 shadow sm:rounded-lg">
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            {reservationRatingCategories.map((item, index) => (
                                                <tr key={index}>
