...
export default function Index(props) {
    const { data: reservationCarCategories, meta, filtered, attributes } = props.reservationCarCategories;
    ...
    const destroyquestion = () => {
        Inertia.delete(route("reservationCarCategories.destroy", state.id), {
                                ...
                                <div className="border-b border-gray-200 shadow sm:rounded-lg">
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            {reservationCarCategories.map((item, index) => (
                                                <tr key={index}>
