                    ...
                    <section className="col-span-10 col-start-2">
                        <div className="relative flex flex-col justify-between h-full">
                            <div className="flex-1">
                                <h1 className="max-w-4xl md:mt-10 text-xl font-bold tracking-tighter text-invert sm:text-3xl md:text-6xl leading-1 lg:leading-[1]">
                                    ...
                                    <span className="block pb-2 -mt-2 tracking-tight text-transparent sm:text-xl md:text-5xl bg-gradient-to-r from-blue-600 dark:via-sky-300 via-sky-500 dark:to-cyan-400 to-cyan-500 bg-clip-text lg:mt-4">
                                        <span>ketingkat yang berikutnya.</span>
                                    </span>
                                </h1>
                                <p className="max-w-2xl mt-2 text-base leading-relaxed text-muted lg:text-xl md:mt-3">
                                    Tingkatkan kemampuan Anda dengan parsinta
                                    dengan mendorong keterampilan Anda ke
                                    tingkat berikutnya, melalui seri-seri di
                                    sini seperti
                                </p>
                            </div>
