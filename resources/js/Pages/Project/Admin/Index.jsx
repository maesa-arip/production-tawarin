...
export default function Index(props) {
    ...
    return (
        <>
            <Head title="Plans" />
            <Container>Admin Perencanaan</Container>
            <DestroyModal
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            {plans.map((plan, index) => (
                                                <tr key={plan.id}>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                    {plan.is_approved == 1 ? <Button>Diterima</Button> : <Button color="yellow">Menunggu Konfirmasi</Button>}
