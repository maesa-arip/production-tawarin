...
import { IconBuildingSkyscraper, IconBuildingStore, IconCash, IconHomeEdit, IconListSearch, IconTools, IconUserSearch } from "@tabler/icons";
    ...
    return (
        <>
            ...
            <div className="flex flex-col lg:col-span-5 xl:col-span-6">
                <div className="relative my-auto overflow-hidden bg-white shadow-xl z-9 rounded-xl ring-1 ring-slate-900/5 xl:mt-18">
                    <section>
...
Pilar.layout = (page) => <App children={page}></App>;
