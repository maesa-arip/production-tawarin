...
export default function NavbarDefault2() {
    const {
        auth,
        categories_global,
        carts_global_count,
    ...
    const [isOpenMenuModalReservasi, setIsOpenMenuModalReservasi] =
        useState(false);
    const [isOpenMenuModalKonstruksi, setIsOpenMenuModalKonstruksi] =
        useState(false);
    const openMenuModal = () => {
        setIsOpenMenuModal(true);
    };
    const openMenuModalReservasi = () => {
        setIsOpenMenuModalReservasi(true);
    };
    const openMenuModalKonstruksi = () => {
        setIsOpenMenuModalKonstruksi(true);
    };
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <div className="grid items-center justify-between grid-cols-2 gap-x-12 gap-y-4">
                        <button
                            // onClick={() => {setIsOpenMenuModal(true); openMenuModalReservasi}}
                            onClick={openMenuModalReservasi}
                            // onClick={() => setIsOpenMenuModal(false)}
                            // href={route("homereservasi")}
                        >
                        ...
                        <button
                            onClick={openMenuModalKonstruksi}
                            // onClick={() => setIsOpenMenuModal(false)}
                            // href={route("homekonstruksi")}
                        >
                ...
                <MenuModal
                    isOpenMenuModal={isOpenMenuModalReservasi}
                    setIsOpenMenuModal={setIsOpenMenuModalReservasi}
                >
                ...
                <MenuModal
                    isOpenMenuModal={isOpenMenuModalKonstruksi}
                    setIsOpenMenuModal={setIsOpenMenuModalKonstruksi}
                >
                    <div className="grid items-center justify-between grid-cols-3 gap-x-12 gap-y-4">
                    <NavLinkMobile
                            onClick={() => setIsOpenMenuModal(false)}
