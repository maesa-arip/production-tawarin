            ...
            <div className="flex p-5">
                <ul className="flex flex-wrap">
                    <li>
                        <a
                            href="#"
                            className="inline-flex items-center px-3 py-1 m-2 text-sm text-gray-600 bg-gray-100 rounded-full hover:bg-gray-200"
                            title="Share this post to facebook"
                        >
                            <span>
                                <svg
                                    className="w-auto h-4 mr-2 text-gray-400 fill-current"
