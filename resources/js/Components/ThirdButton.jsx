...
export default function ThirdButton({ type = 'submit', className = '',href, processing, children, onClick, color ='tawarin' }) {
    const colorVariants = {
        ...
        tawarin: 'bg-amber-500 text-white hover:bg-amber-500 focus:bg-amber-600 active:bg-amber-600 focus:ring-amber-600 text-sm leading-5 text-white font-semibold',
