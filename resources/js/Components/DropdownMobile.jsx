...
const Content = ({ align = 'right', width = 'full', contentClasses = 'py-1 bg-white dark:bg-gray-700', children }) => {
...
DropdownMobile.Trigger = Trigger;
DropdownMobile.Content = Content;
DropdownMobile.Link = DropdownLink;
